...
namespace Insight.Website.Views
{
    ...
    public partial class MasterPageHeaderView : BaseWebUserControl, IMasterPageHeaderView
    {
        ...
        protected void AdminClicked(object o, EventArgs e)
        {
            HttpContext.Current.Response.Redirect(ResourceStrings.Page_AdminLanding);
        }
